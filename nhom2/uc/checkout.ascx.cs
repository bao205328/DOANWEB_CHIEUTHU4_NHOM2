        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
           ...
           //nếu thêm oders thành công thì thêm chi tiết oders
            ...
            HamXuLy.SendMail(txtEmailndh.Text.Trim(), "Phản hồi thông tin đơn hàng",
                              "Cảm ơn bạn đã đặt hàng tại BINA Shop chúng tôi.<br/> Đơn hàng của bạn đã được gửi tới hệ thống, chúng tôi sẽ phản hồi bạn trong thời gian sớm nhất.");
