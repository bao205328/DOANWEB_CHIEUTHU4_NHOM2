...
namespace Nhom3.uc
{
    public partial class cart : System.Web.UI.UserControl
    {
        ...
        public String url_checkout = "https://www.facebook.com/quangthangbina";
        ...
        protected void ImageButton1_Click1(object sender, ImageClickEventArgs e)
        {
            ...
            String receiver = "thangbinatv@gmail.com";
            String comments = "BINA Shop";
            String return_url = "https://www.facebook.com/quangthangbina";
            String price = Cart_Temp.TongTien(list).ToString();
            String product = "Sản Phẩm BINA Shop";
